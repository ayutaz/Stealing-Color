...
const LEVELS: LevelConfig[] = [
  {
    ...
    effects: { noise: 0, blurPx: 0, glitchHz: 0, whiteout: 0 }
  },
  {
    state: 'Lv1',
    titleText: '',
    ...
    effects: { noise: 0.03, blurPx: 0.2, glitchHz: 0, whiteout: 0 }
  },
  {
    state: 'Lv2',
    titleText: 'もっと',
    ...
    effects: { noise: 0.08, blurPx: 0.8, glitchHz: 0.4, whiteout: 0 }
  },
  {
    state: 'Lv3',
    titleText: 'やめられないだろ?',
    ...
    effects: { noise: 0.12, blurPx: 1.4, glitchHz: 0.8, whiteout: 0 }
  },
  {
    state: 'Lv4',
    titleText: 'もう戻れない',
    ...
    effects: { noise: 0.18, blurPx: 1.9, glitchHz: 1.3, whiteout: 0 }
  },
  {
    state: 'Lv5',
    titleText: '色を返',
    ...
    effects: { noise: 0.23, blurPx: 2.4, glitchHz: 1.9, whiteout: 0 }
  },
  {
    state: 'Lv6',
    titleText: '色を返せ',
    ...
    effects: { noise: 0.29, blurPx: 3.0, glitchHz: 2.4, whiteout: 0.02 }
  },
  {
    state: 'Lv7',
    titleText: '色を返せ',
    ...
    effects: { noise: 0.35, blurPx: 3.8, glitchHz: 3.2, whiteout: 0.05 }
  },
  {
    state: 'Lv8',
    titleText: '',
    ...
    effects: { noise: 0.43, blurPx: 4.6, glitchHz: 4.0, whiteout: 0.1 }
  },
  {
    state: 'Lv9',
    titleText: '',
    ...
    effects: { noise: 0.53, blurPx: 5.8, glitchHz: 5.4, whiteout: 0.2 }
  },
  {
    state: 'Final',
    ...
    effects: { noise: 0.46, blurPx: 4.9, glitchHz: 6.8, whiteout: 1 }
  }
];
